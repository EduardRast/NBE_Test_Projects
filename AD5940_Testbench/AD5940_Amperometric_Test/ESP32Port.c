...
// #define GPIO_SCLK      7   // D13 in Arduino UNO terms
// #define GPIO_MISO      8   // D12 in Arduino UNO terms
// #define GPIO_MOSI      9   // D11 in Arduino UNO terms
// #define GPIO_CS        1   // D10 in Arduino UNO terms
// #define AD5940_CS_PIN  4   // this is the true CS pin, AD5940 will not work with the default CS pin.
// #define AD5940_GP0INT_PIN 3    // A3/D17 in Arduino UNO terms
// #define AD5940_RST_PIN  2 // A1 in Arduino UNO terms

// this pin configuration is for xiao esp32s3
...
#define GPIO_CS  8    // D10 in Arduino UNO terms, this is a dummy pin that will not be used (AD5940 library was programmed in such a way that chip selects are handled manually)
#define AD5940_CS_PIN  10   // this is the true CS pin, AD5940 will not work with the default CS pin.
#define AD5940_GP0INT_PIN  4 // D2 in Arduino UNO terms, this connects to GPIO0 of AF5940
#define AD5940_RST_PIN  5    // A3/D17 in Arduino UNO terms
///////////////////////////////////////////////////////////////////////////////////////
